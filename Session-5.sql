...
CREATE TABLE IF NOT EXISTS vacation_plan
	(
	place id			INT, -- WATCH OUT! do not leave column names blank. If you do so no error raises. But your column name wil be divided into 2 parts in the header cell.
	country				NVARCHAR(50),
	hotel name 			NVARCHAR(100),
...
INSERT INTO vacation_plan VALUES(NULL, NULL, "HOTEL ISTANBUL", 1, 7, 4000);

/*vacation_plan tablosuna vacation_lenght ve budget sutunlarını eksik olarak veri girişi 
yapınız*/

INSERT INTO vacation_plan (place, country, hotel, employee) VALUES (06, "TURKEY", "HOTEL BASKENT", 3);
...
CREATE TABLE workers (
	...
	INSERT INTO workers (id, id_number, salary) VALUES (4, "57535638976", 9000)
	
	-- UNIQUE CONST VIOLATION
	-- INSERT INTO workers VALUES(1, "12345678910", "Can Canan", 10000;) -- id column "1" terar edilemez
...
/* Employees tablosunda bulunmayan bir kişi için (EmployeeId=9) olan kişi için bir tatil planı giriniz.*/
 ...
 INSERT INTO vacation_plan2 VALUES(35,"TURKEY", 'HOTEL DELRAY',9, 4,5000);
...
/*workers tablosunun adını people olarak degistiriniz */
